...
type Task struct {
	...
	CreatedAt   time.Time `json:"created" sql:"type:datetime" gorm:"column:created"`
	UpdatedAt   time.Time `json:"updated" sql:"type:datetime" gorm:"column:updated"`
	CompletedAt time.Time `json:"completed" sql:"type:datetime" gorm:"column:completed"`
